		  	    	   ...
		  	    	   m("div",
			  	    	   [ 
			  	    		   // m("td", m("h3", m('label', "Commentaire de: " + item.properties.owner + " : "+ " ."))),
			  	    		     ...
			  	    		     m("td",m("h4", item.properties.body))
		  	    	     ...
		  	    	     m("div",
			  	    		...
			  	    		m("center", m("td", m("button", {
		 	  	    	     ...
		 	  	    	     m("td", m('label', "")),
 	  	    	     		 ...
 	  	    	     		 m("center", m('label', "")),
 	  	    	  			 m('label', "____________________________________________________________________________________________"),
 	  	    				 m("center", m('label', "")),
 	  	    				 m("center", m('label', ""))
...
view: function() {
 ...
 return [m("div", {"class":"wrapper "},
    [
        ...
        [
          m("div", {"class":"logo"},
            [
              ...
              m("a", {"class":"simple-text logo-normal","href":"/paper-dashboard-master/MyProfile.jsp"}, 
                " My Profile "
              ) 
            ]
          ),
      ...
      m("div", {"class":"main-panel","style":{"height":"40vh"}},
        [
          ...
          m("div", {"class":"content"}, 
            m("div", {"class":"row"}, 
              m("div", {"class":"col-md-12"}, 
            	m("center", m("h1", {"class":"description"}, 
            	        "Accueil"
            	                )),
