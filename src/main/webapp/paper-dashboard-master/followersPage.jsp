...
//   		}
  ...
  var AbonnementList = {
  	    ...
  	    next: function() {
  	        return m.request({
  	            method: "GET",
  	            url: "./_ah/api/myApi/v1/abonnementList/"+"?next="+AbonnementList.nextToken})
  	        .then(function(result) {
  	        	console.log("got:",result)
     	...
     	showfollowers : function(e){  
    		 window.location = "/paper-dashboard-master/abonnementsPage.jsp";
    	 },
  	    ...
  	    AbonnementList.list.map(function(item) {
  	      return m("tr", [
  	       ...
  	       // m('td', m('label', item.properties.NbFollowBy)),
    		  ...
    		  UsersList.showfollowers(item.key.id);
        ...
        [
          m("div", {"class":"logo"},
            [
              ...
              m("a", {"class":"simple-text logo-normal","href":"/paper-dashboard-master/mainBoy.jsp"}, 
                " Actualités "
              )
            ]
          ),
