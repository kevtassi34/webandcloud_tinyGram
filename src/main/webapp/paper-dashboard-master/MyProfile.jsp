...
//   		}
  ...
  var MyPost = {
  	    ...
  	    loadList: function() {
  	        return m.request({
  	            method: "GET",
  	            url: "./_ah/api/myApi/v1/myprofile/"})
  	    ...
  	    next: function() {
  	        return m.request({
  	            method: "GET",
  	            url: "./_ah/api/myApi/v1/myprofile/"+"?next="+MyPost.nextToken})
  	        .then(function(result) {
  	        	console.log("got:",result)
  ...
  var PostView = {
    ...
    view: function() {
    	...
    	return m("center", m('div', {class:'card',"style":{"width":"60rem"}}, [
    	  	  
	  	    MyPost.list.map(function(item) {
	  	      return m('div', {"class":"card","style":{"width":"60rem"}},
	  	    		 [ 
	  	    		
	  	    	 m("h6", m("div", m('div',{class:'subtitle'}, item.properties.owner))),
	  	    	     m("center", m('img', {class: 'card-img-top', 'src': item.properties.url, "alt":"Card image cap"})),
	  	    	     m("center", m('label', "")),
	  	    	     
	  	    	   m("div",
		  	    	   [ 
		  	    		   // m("td", m("h3", m('label', "Commentaire de: " + item.properties.owner + " : "+ " ."))),
	  	    	    		
		  	    		     m("td",m("h3", item.properties.body))
	  	    	     ...
	  	    	     m("div",
				  	    	   [ 
				  	    		   // m("td", m("h3", m('label', "Commentaire de: " + item.properties.owner + " : "+ " ."))),
				  	    		     ...
				  	    		     m("td",m("h4", item.properties.comments + "_")),
				  	    		  	 m("td", m("h1", m('label', " "))),
	  	    	     ...
	  	    	     m("div",
		  	    		...
		  	    		m("center", m("td", m("button", {
	 	  	    	  	  ...
	 	  	    	  	  }, m("i", {"class":"fa fa-heart heart"}), " " + item.properties.likec)),
	 	  	    	  	  
	 	  	    	  	  //Créer l'ecart entre les boutons
	 	  	    	     m("td", m('label', "")),
	 	  	    	 	 ...
	 	  	    	 	 m("td", m("button", {
 	  	    	  		  ...
 	  	    	  		  onclick: function(e) {
 	  	    	  			  ...
 	  	    	  			  MyPost.commentPost(item.key.id);
	  	    	  		  ...
	  	    	  		  m("td", m('button',{
	  	    	  	       ...
	  	    	  	       class: 'button is-danger',
	  	    	     		 ...
	  	    	     		 m("center", m('label', "")),
	  	    	  			 m('label', "___________________________________________________________________"),
	  	    				 m("center", m('label', "")),
	  	    				 m("center", m('label', ""))
	  ...
	  m("center",m("h1", m("td", m('button',{
 	      ...
 	      onclick: function(e) {MyPost.next()},"style":{"width":"150vh","height":"5vh"}
 	      },
	  "Next"))))      
    ...
    [
      m("div", {"class":"sidebar","data-color":"white","data-active-color":"danger"},
        [
          m("div", {"class":"logo"},
            [
              m("a", {"class":"simple-text logo","href":"/paper-dashboard-master/mainActu.jsp "},
                [
              ...
              m("center", m("a", {"class":"simple-text logo-normal","href":" "}, 
                 "My Profile "
                )) 	
//               MyPost.list.map(function(item) { 
//             	  return m('a',{"class":"simple-text logo-normal","href":" "}, item.properties.owner)
//                  }),
      ...
      m("div", {"class":"main-panel","style":{"height":"100vh"}},
        [
          m("nav", {"class":"navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent"}, 
...
//         [		
       ...
       // ),
        ...
        m("div", {"class":"main-panel","style":{"width":"200vh","height":"60vh"}},
         [		
...
// 	  Hello.name=profile.getName();
// 	  Hello.email=profile.getEmail();
// 	  Hello.ID=googleUser.getAuthResponse().id_token;
// 	  Hello.url=profile.getImageUrl();
// 	  m.route.set("/Hello")
// 	}
