		...
		body:"",
		  ...
		  view: function() {
		    return m("form", {
		     ...
		     m('div',{class:'control'},m("button[type=submit]", {class:'button is-default'},"Post")),
		      															                   
		      															
		      MyPost.list.map(function(item) {
		    	  return m("button", {class:'button is-link', 
					 				onclick: function(e, c) {
		  		    
									MyPost.afterComment(item.key.id, PostForm.body)
					 				}},"Envoyer")
...
//}),
//MyPost.list.map(function(item) {
//	return m("h6",m('label', item.properties.userconnected))
//	}
...
var MyPost = {
	    ...
	    postComment: function() {
     		...
     		return m.request({
         		method: "POST",
         		url: "_ah/api/myApi/v1/postComment",
        ...
        deleteAllPost: function(){
       	...
       	afterComment: function(e, c){
       	 var url = "/commentpost/" + e + c
   		 window.location = url;
