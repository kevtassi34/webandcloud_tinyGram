...
@WebServlet(name = "Abonnements", urlPatterns = { "/abonnements" })
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		for (Entity entity : result) {
			...
			if (lastName.equals(user)) { 
				...
				response.getWriter().print( "<h2><li> Vous avez " + FollowersNull.size() + " Abonné. :-( </h2><br><br>");
				//response.getWriter().print( "<li> les voici " + Followers + " Abonnés <br><br>");
				
				}
				else {
					response.getWriter()
					.println( "<p><h3> <a href=/paper-dashboard-master/abonnementsPage.jsp> Cliquez ici pour revenir à la liste des Utilisateurs </a> </h3></p></br>");
		...
		response.getWriter()
		.println( "<p><h3> <a href=/paper-dashboard-master/abonnementsPage.jsp> Cliquez ici pour revenir à la liste des Utilisateurs </a> </h3></p>");
